...
public class ReviewWriteServiceImpl implements ReviewWriteService {
	...
	private static final String SEARCH_BOOK_INFO = "/v1/books/searchById";
	...
	private Mono<Book> fetchBook(String bookId) {
		StringBuilder searchBookInfoUri = new StringBuilder(BOOK_API_HOST)
		...
		return webClient.mutate()
			.build()
			.get()
			.uri(String.valueOf(searchBookInfoUri))
			.retrieve()
