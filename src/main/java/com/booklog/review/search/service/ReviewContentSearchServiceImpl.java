...
public class ReviewContentSearchServiceImpl implements ReviewSearchService{
	...
	public List<Review> findReviewsByTerm(String keyword) {
		return Review.listOf(reviewSearchRepository.findReviewEntitiesByReviewContentRegex(
